...
% E data
session_type = 'E';
dir_2 = ['/home/ConSegAP/data/raw/BCICIV_2a_gdf/A0',num2str(subject_index),session_type,'.gdf'];
[s, HDR] = sload(dir_2);

% Label 
% label = HDR.Classlabel;
labeldir_2 = ['/home/ConSegAP/data/raw/true_labels/A0',num2str(subject_index),session_type,'.mat'];
load(labeldir_2);
label_2 = classlabel;
...
label = label_1;
% label = t_label + 1;
saveDir = ['/home/ConSegAP/data/bci_iv_2a/standard_2a_data/A0',num2str(subject_index),'T.mat'];
save(saveDir,'data','label');

data = data_2;
label = label_2;
saveDir = ['/home/ConSegAP/data/bci_iv_2a/standard_2a_data/A0',num2str(subject_index),'E.mat'];
save(saveDir,'data','label');
